...
def create_phase_logger(log_directory: Path, name: str = "stackelberg_3d") -> logging.Logger:
    ...
    name:
        Stable logger name (distinct from p1b_4D's "stackelberg" logger so
        the two packages never share a global logging.Logger instance).
    ...
    log_path = (log_directory / "stackelberg_3d.log").resolve()
    existing_paths = {
